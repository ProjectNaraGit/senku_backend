...
<body class="bg-[#5F6F52]">
        ...
        <div class="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-6">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm">
                ...
                <?php $__currentLoopData = $paymentOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="flex items-center gap-4 p-4 border rounded-xl mb-4 cursor-pointer payment-option <?php echo e($loop->last ? '' : ''); ?>" data-method="<?php echo e($option['key']); ?>">
                        <input type="radio" name="payment" value="<?php echo e($option['key']); ?>" class="mt-1 accent-orange-500 payment-radio">
                        <div class="flex-1">
                            <p class="font-medium"><?php echo e($option['label']); ?></p>
                            <p class="text-sm text-gray-500"><?php echo e($option['description']); ?></p>
                        </div>
                        <img src="<?php echo e($option['logo']); ?>" alt="Logo <?php echo e($option['label']); ?>" class="w-12 h-12 rounded-lg border border-gray-100 object-contain bg-white p-2">
                    </label>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm h-fit">
                ...
                <?php if(isset($items) && count($items) > 0): ?>
                    ...
                    <div class="flex gap-4 pb-4 mb-4 <?php echo e(!$loop->last ? 'border-b' : ''); ?>">
                        <div class="w-16 h-16 rounded-lg bg-gray-300 overflow-hidden shrink-0">
                            <?php
                                $itemImage = $item['image'] ?? null;
                            ?>
                            <?php if(!empty($itemImage)): ?>
                                <img src="<?php echo e($itemImage); ?>" alt="<?php echo e($item['name']); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500">Qty: <?php echo e($item['qty']); ?> x Rp <?php echo e(number_format($item['price'], 0, ',', '.')); ?></p>
                            <p class="text-sm mt-1 font-semibold text-orange-500">Rp <?php echo e(number_format($item['subtotal'], 0, ',', '.')); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                ...
                <div class="flex justify-between items-center mt-6 pt-6 border-t font-semibold">
                    ...
                    <span class="text-orange-500">Rp <?php echo e(number_format($total ?? 0, 0, ',', '.')); ?></span>
                </div>
            </div>
        </div>
          ...
          <div class="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div class="p-6 md:p-8">
                  ...
                  <div class="bg-orange-50 rounded-xl p-6 mb-6">
                      ...
                      <div class="mt-4 pt-4 border-t border-orange-200">
                          <div class="flex justify-between items-center">
                              ...
                              <span class="text-xl font-bold text-orange-500">Rp <?php echo e(number_format($total ?? 0, 0, ',', '.')); ?></span>
                          </div>
                      </div>
                  </div>
                  ...
                  <form id="payment-proof-form" enctype="multipart/form-data">
                      ...
                      <input type="hidden" name="total" value="<?php echo e($total ?? 0); ?>">
                      <input type="hidden" name="items" value="<?php echo e(json_encode($items ?? [])); ?>">
  ...
  <script>
      ...
      const paymentDetails = <?php echo json_encode($paymentDetailsData, 15, 512) ?>;
      ...
      paymentProofForm.addEventListener('submit', function(e) {
          ...
          // Send to server
          fetch('<?php echo e(route("checkout.upload-proof")); ?>', {
              method: 'POST',
              body: formData,
              headers: {
          ...
          .then(data => {
              if (data.success) {
                  ...
                  window.location.href = '<?php echo e(route("order.co-finish")); ?>';
              } else {
...
</html><?php /**PATH C:\LARAGON\laragon\www\senku-backend\resources\views/order/co-bayar.blade.php ENDPATH**/ ?>