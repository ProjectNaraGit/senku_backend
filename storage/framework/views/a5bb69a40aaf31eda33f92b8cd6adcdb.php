...
<body class="bg-dark-backdrop">        
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
            ...
            <li>
                <a href="<?php echo e(route('admin.layanan.index')); ?>" class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
            ...
            <li>
                <a href="<?php echo e(route('admin.testimoni.index')); ?>" class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
            ...
            <li>
                <a href="<?php echo e(route('admin.order.index')); ?>" class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group">
                <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-fg-brand" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 13h3.439a.991.991 0 0 1 .908.6 3.978 3.978 0 0 0 7.306 0 .99.99 0 0 1 .908-.6H20M4 13v6a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-6M4 13l2-9h12l2 9M9 7h6m-7 3h8"/></svg>
                <span class="flex-1 ms-3 whitespace-nowrap">Order</span>
                <?php if($pendingOrdersCount > 0): ?>
                <span class="inline-flex items-center justify-center w-4.5 h-4.5 ms-2 text-xs font-medium text-fg-brand-strong bg-brand-soft border border-brand-subtle rounded-full"><?php echo e($pendingOrdersCount); ?></span>
                <?php endif; ?>
                </a>
            </li>
            <li>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?php echo e(route('admin.order.index')); ?>" class="text-white bg-neutral-secondary-medium hover:bg-neutral-tertiary border border-default font-medium rounded-base text-sm px-4 py-2.5">
                    Kembali
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">    
                <div class="bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                    ...
                    <h5 class="<?php echo e(strlen($pesanan->kode_pesanan) > 15 ? 'text-sm' : 'text-xl'); ?> font-semibold text-white break-all"><?php echo e($pesanan->kode_pesanan); ?></h5>
                </div>
                <div class="bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                    <p class="text-white mb-2">Pemesan</p>
                    <h5 class="text-xl font-semibold text-white"><?php echo e($pesanan->nama_pemesan); ?></h5>
                </div>
                <div class="bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                    <p class="text-white mb-2">Deadline</p>
                    <h5 class="text-xl font-semibold text-white"><?php echo e($pesanan->deadline->format('d F Y')); ?></h5>
                </div>
                <div class="bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                    <p class="text-white mb-2">Total Harga</p>
                    <h5 class="text-xl font-semibold text-white">Rp <?php echo e(number_format($pesanan->total_harga, 0, ',', '.')); ?></h5>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-white font-medium"><?php echo e($pesanan->layanan->nama_layanan ?? '-'); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-400 text-sm">Email Pemesan</p>
                            <p class="text-white"><?php echo e($pesanan->email_pemesan); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-400 text-sm">Telepon</p>
                            <p class="text-white"><?php echo e($pesanan->telepon); ?></p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-white"><?php echo e($pesanan->created_at->format('d F Y, H:i')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                    ...
                    <p class="text-white whitespace-pre-line"><?php echo e($pesanan->deskripsi_tugas); ?></p>
                    
                    <?php if($pesanan->file_pendukung): ?>
                    <div class="mt-4">
                        <p class="text-gray-400 text-sm mb-2">File Pendukung</p>
                        <a href="<?php echo e(asset('storage/' . $pesanan->file_pendukung)); ?>" target="_blank" class="text-blue-400 hover:underline">
                            Lihat File
                        </a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-white"><?php echo e($pesanan->catatan_admin); ?></p>
                    </div>
                    <?php endif; ?>

                    <?php if($pesanan->payment_method): ?>
                    <div class="mt-4">
                        <p class="text-gray-400 text-sm mb-2">Metode Pembayaran</p>
                        <p class="text-white"><?php echo e(ucfirst($pesanan->payment_method)); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="mt-6">
                <div class="bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                    ...
                    <img src="<?php echo e(asset('storage/' . $pesanan->payment_proof)); ?>" alt="Bukti Pembayaran" class="max-w-full h-auto rounded-base border border-default">
                </div>
            </div>
            <?php endif; ?>

            <div class="mt-6">
                <a href="<?php echo e(route('admin.order.edit', $pesanan->id)); ?>" class="text-white bg-brand hover:bg-brand-strong border border-transparent font-medium rounded-base text-sm px-4 py-2.5">
                    Update Status
                </a>
            </div>
        </div>
...
<?php /**PATH C:\LARAGON\laragon\www\senku-backend\resources\views/admin/order-detail.blade.php ENDPATH**/ ?>