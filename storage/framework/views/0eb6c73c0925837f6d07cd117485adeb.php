...
<head>
  ...
  <style>
    ...
    .science-splash::after {
      ...
      background-position: left 60px top 140px, right 60px bottom 90px;
      opacity: 0.18;
      pointer-events: none;
      z-index: 0;
    }
...
<body class="bg-[#5F6F52]">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-5 items-center ml-auto">
          ...
          <div class="relative">
            ...
            <div
              id="loginDropdown"
              class="hidden absolute right-0 mt-2 w-44 bg-white rounded-lg z-[100] overflow-hidden"
            >
  ...
  <main>
    <section class="pattern-overlay science-splash w-full bg-[#5F6F52] px-7.5 md:px-30 py-20 flex flex-col items-center gap-2">
      ...
      <?php if($cartItems->count() > 0): ?>
        <div class="w-full bg-white p-6 md:p-10 rounded-2xl">
          <div class="space-y-4">
            <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="flex flex-col md:flex-row items-center gap-4 p-4 border-b border-gray-200 last:border-0">
                <div class="w-20 h-20 rounded-lg bg-gray-200 overflow-hidden flex-shrink-0 flex items-center justify-center">
                  <?php ($thumbnail = $item->layanan->thumbnail_url); ?>
                  <?php if($thumbnail): ?>
                    <img src="<?php echo e($thumbnail); ?>" alt="<?php echo e($item->layanan->nama_layanan); ?>" class="w-full h-full object-cover">
                  <?php else: ?>
                ...
                <div class="flex-1">
                  <h3 class="font-semibold text-lg"><?php echo e($item->layanan->nama_layanan); ?></h3>
                  <p class="text-sm text-gray-600"><?php echo e(Str::limit($item->layanan->deskripsi_layanan, 80)); ?></p>
                  <p class="text-sm font-semibold text-[#5F6F52] mt-1">Rp <?php echo e(number_format($item->harga_satuan, 0, ',', '.')); ?></p>
                </div>

                <div class="flex items-center gap-3">
                  <span class="text-gray-700">Qty: <?php echo e($item->quantity); ?></span>
                </div>

                <div class="flex flex-col items-end gap-2">
                  <p class="font-bold text-lg">Rp <?php echo e(number_format($item->subtotal, 0, ',', '.')); ?></p>
          ...
          <div class="mt-6 pt-6 border-t border-gray-300">
            <div class="flex justify-between items-center mb-4">
              ...
              <span class="text-2xl font-bold text-[#5F6F52]">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
            </div>
            <div class="flex gap-4">
              <a href="<?php echo e(route('user.dashboard')); ?>" class="flex-1 text-center py-3 px-6 border-2 border-[#5F6F52] text-[#5F6F52] rounded-lg font-semibold hover:bg-gray-50 transition">
                Lanjut Belanja
              </a>
              <a href="<?php echo e(route('cart.checkout')); ?>" class="flex-1 py-3 px-6 bg-[#5F6F52] text-white rounded-lg font-semibold hover:bg-[#4a5841] transition text-center">
                Checkout
              </a>
            </div>
          </div>
      ...
      <?php else: ?>
        <div class="flex flex-col md:flex-row w-full bg-white p-10 gap-7 rounded-2xl">
          ...
          <div class="flex flex-col w-fuil">
            ...
            <a href="<?php echo e(route('user.dashboard')); ?>" class="w-fit mt-3 font-poppins font-bold text-white bg-[#5F6F52] py-1 px-20 rounded-xl text-center">Mulai Belanja</a>
          </div>
        </div>
      <?php endif; ?>
    </section>
      ...
      <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-[#5F6F52] text-center sm:text-left">
        ...
        <div class="space-y-4">
          ...
          <div class="flex gap-3 justify-center sm:justify-start flex-wrap">
            <a href="https://instagram.com/senkusolutions" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow hover:scale-105 transition">
              <img src="<?php echo e(asset('images/instagram.png')); ?>" class="w-[22px] h-[22px]" />
            </a>
            <a href="https://tiktok.com/@senkusolutions" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow hover:scale-105 transition">
              <img src="<?php echo e(asset('images/tiktok.png')); ?>" class="w-[22px] h-[22px]" />
            </a>
            <a href="https://x.com/senkusolutions" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow hover:scale-105 transition">
              <img src="<?php echo e(asset('images/x.png')); ?>" class="w-[22px] h-[22px]" />
            </a>
            <a href="https://threads.net/@senkusolutions" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow hover:scale-105 transition">
...
</html><?php /**PATH C:\LARAGON\laragon\www\senku-backend\resources\views/user/cart.blade.php ENDPATH**/ ?>