...
<body class="bg-dark-backdrop">        
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="<?php echo e(route('admin.testimoni.index')); ?>" class="flex items-center px-2 py-1.5 text-body rounded-base bg-neutral-secondary-soft text-heading">
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="p-4">
            <div class="bg-neutral-primary-soft border border-default rounded-base shadow-xs p-6">
                ...
                <form action="<?php echo e(route('admin.testimoni.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="odd:bg-neutral-primary even:bg-neutral-secondary-soft border-b border-default">
                                    <td class="px-6 py-4">
                                        <img src="<?php echo e($imageSource); ?>" alt="Testimoni <?php echo e($testimonial->id); ?>" class="w-24 h-24 object-cover rounded-base border border-default">
                                    </td>
                                    <td class="px-6 py-4 text-xs text-body break-all">
                                        <?php echo e($testimonial->image_path); ?>

                                    </td>
                                    <td class="px-6 py-4">
                                        <form action="<?php echo e(route('admin.testimoni.destroy', $testimonial)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus testimoni ini?')">
                                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\LARAGON\laragon\www\senku-backend\resources\views/admin/testimoni.blade.php ENDPATH**/ ?>