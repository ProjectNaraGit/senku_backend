...
<head>
  ...
  <style>
    ...
    .js-enabled .hero-fade-left,

    .js-enabled .hero-fade-right,

    .js-enabled .hero-fade-up {
    ...
    .hero-fade-left.hero-fade-visible {
    ...
    .hero-fade-right.hero-fade-visible {
    ...
    .hero-fade-up.hero-fade-visible {
  ...
  <style>
    ...
    .pattern-overlay::before {
      ...
      background-image: url('<?php echo e(asset('images/Background_pattern.png')); ?>');
...
<body class="bg-[#5F6F52] overflow-x-hidden">
  ...
  <nav class="w-full px-4 md:px-30 py-4 bg-[#E5E0D8] sticky top-0 z-50 border-b border-gray-700">
      ...
      <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('images/7343c1fc35b5281de35c18d65f3824a08927c1b7.png')); ?>"
        ...
        <div class="relative">
          ...
          >
            ...
            <a href="<?php echo e(route('siswa.login')); ?>" class="block px-4 py-2 text-white hover:bg-[#37402f]">

              Siswa

            </a>

            <a href="<?php echo e(route('mahasiswa.login')); ?>" class="block px-4 py-2 text-white hover:bg-[#37402f]">

              Mahasiswa

            </a>

            <a href="<?php echo e(route('umum.login')); ?>" class="block px-4 py-2 text-white hover:bg-[#37402f]">
    ...
    <section id="hero-section" class="pattern-overlay w-full relative min-h-[420px] max-[500px]:min-h-[350px] md:min-h-[300px] bg-[#2f4a33]">
      ...
      <div class="absolute inset-0 z-0 mt-0 md:-mt-16">
        <video 
          id="heroVideo"
          src="<?php echo e(asset('videos/hero.mp4')); ?>" 
          alt="Hero Video" 
      ...
      <div id="hero-about-dropdown" data-expanded="false" class="pattern-overlay w-full bg-[#2f4a33] border-transparent rounded-none p-0 text-white space-y-0 shadow-none overflow-hidden relative -z-10" style="max-height: 0; opacity: 0; transition: max-height 0.45s ease, opacity 0.45s ease; z-index: 1">
        ...
        <div class="relative">
          ...
          <div class="absolute inset-0 pointer-events-none" style="background-image: url('<?php echo e(asset('images/Background_pattern.png')); ?>'); background-size: 520px; background-repeat: repeat; opacity: 0.15; z-index: 2;"></div>
        ...
        <div class="rounded-[20px] md:max-w-72 text-[12px] md:text-[14px] flex-1 p-4 bg-white -mt-6 md:-mt-4 shadow-xl shadow-gray-400 flex flex-col h-auto min-h-[auto] md:min-h-[360px] hero-fade-up z-10" data-hero-animate>
          ...
          <div class="flex items-start gap-3 mb-2 min-h-[80px] md:min-h-[120px]">
            ...
            <div class="flex-1">
              ...
              <img src="<?php echo e(asset('images/e7112bf1923a361b34ce13055c57d032c50a17ca.png')); ?>" alt="icon" class="w-12 h-12 md:w-16 md:h-16">
        ...
        <div class="rounded-[20px] md:max-w-72 text-[12px] md:text-[14px] flex-1 p-4 bg-white mt-0 md:-mt-4 shadow-xl shadow-gray-400 flex flex-col h-auto min-h-[auto] md:min-h-[360px] hero-fade-up z-10" data-hero-animate>
          ...
          <div class="flex items-start gap-3 mb-2 min-h-[80px] md:min-h-[120px]">
            ...
            <div class="flex-1">
              ...
              <img src="<?php echo e(asset('images/78b570f382834f7c2682ac6349195a12978b9273.png')); ?>" alt="icon" class="w-12 h-12 md:w-16 md:h-16">
        ...
        <div class="rounded-[20px] md:max-w-72 text-[12px] md:text-[14px] flex-1 p-4 bg-white mt-0 md:-mt-4 shadow-xl shadow-gray-400 flex flex-col h-auto min-h-[auto] md:min-h-[360px] hero-fade-up z-10" data-hero-animate>
          ...
          <div class="flex items-start gap-3 mb-2 min-h-[80px] md:min-h-[120px]">
            ...
            <div class="flex-1">
              ...
              <img src="<?php echo e(asset('images/ac1a0c3d62e9c6c03c8dd582e9d5f93097ccb8ec.png')); ?>" alt="icon" class="w-12 h-12 md:w-16 md:h-16">
    ...
    <section id="layanan" class="pattern-overlay w-full py-15 px-7.5 md:px-30  bg-[#E5E0D8]">
      ...
      <div class="w-full grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="flex-1 lg:max-w-70 max-w-none bg-white p-4 rounded-[30px]">
          ...
          <div class="w-full h-32 md:h-40 rounded-[22px] overflow-hidden mb-3">
            ...
            <img src="<?php echo e(asset('images/akademik_riset.png')); ?>" alt="Akademik & Riset" class="w-full h-full object-cover">
        ...
        <div class="flex-1 lg:max-w-70 max-w-none bg-white p-4 rounded-[30px]">
          ...
          <div class="w-full h-32 md:h-40 rounded-[22px] overflow-hidden mb-3">
            ...
            <img src="<?php echo e(asset('images/kreatif_visual.png')); ?>" alt="Kreatif & Visual" class="w-full h-full object-cover">
        ...
        <div class="flex-1 lg:max-w-70 max-w-none bg-white p-4 rounded-[30px]">
          ...
          <div class="w-full h-32 md:h-40 rounded-[22px] overflow-hidden mb-3">
            ...
            <img src="<?php echo e(asset('images/konsultasi_hukum_psikologi.png')); ?>" alt="Konsultasi Hukum & Psikologi" class="w-full h-full object-cover">
        ...
        <div class="flex-1 lg:max-w-70 max-w-none bg-white p-4 rounded-[30px]">
          ...
          <div class="w-full h-32 md:h-40 rounded-[22px] overflow-hidden mb-3">
            ...
            <img src="<?php echo e(asset('images/teman_belajar.png')); ?>" alt="Partner Belajar" class="w-full h-full object-cover">
    ...
    <section class="pattern-overlay w-full py-15 px-7.5 md:px-30  bg-[#E5E0D8]">
      ...
      <div class="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-5 md:gap-6">
        ...
        <div class="bg-[#5F6F52] p-5 md:p-6 rounded-2xl flex flex-col h-full min-h-[320px]">
          ...
          <div class="w-full h-[180px] md:h-[220px] rounded-[20px] overflow-hidden shrink-0 mt-auto">
            ...
            <img src="<?php echo e(asset('images/skripsi_perBab.png')); ?>" alt="layanan1" class="w-full h-full object-cover">
        ...
        <div class="bg-[#5F6F52] p-5 md:p-6 rounded-2xl flex flex-col h-full min-h-[320px]">
          ...
          <div class="w-full h-[180px] md:h-[220px] rounded-[20px] overflow-hidden shrink-0 mt-auto">
            ...
            <img src="<?php echo e(asset('images/design_poster_banner.png')); ?>" alt="layanan1" class="w-full h-full object-cover">
        ...
        <div class="bg-[#5F6F52] p-5 md:p-6 rounded-2xl flex flex-col h-full min-h-[320px]">
          ...
          <div class="w-full h-[180px] md:h-[220px] rounded-[20px] overflow-hidden shrink-0 mt-auto">
            ...
            <img src="<?php echo e(asset('images/olah_data.png')); ?>" alt="layanan1" class="w-full h-full object-cover">
    ...
    <section class="pattern-overlay w-full py-15 px-7.5 md:px-30  bg-[#E5E0D8]">
      ...
      <div class="relative max-w-7xl mx-auto px-4 md:px-0">
          ...
          <div id="testimonialSlider" class="flex flex-row gap-4 xl:gap-5 transition-none xl:transition-transform xl:duration-700 xl:ease-in-out items-stretch">
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[45vw] lg:w-[400px] xl:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto min-h-[200px] snap-center">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="<?php echo e(asset('images/testimoni1.jpeg')); ?>" alt="Mahasiswa Hukum" class="w-10 h-10 rounded-full shrink-0 object-cover">

                <div class="ml-3">

                  <p class="font-semibold font-poppins text-[15px]">Mahasiswa Hukum</p>

                  <p class="font-poppins text-sm text-gray-600">Pengguna Senku Academic</p>
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[45vw] lg:w-[400px] xl:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto min-h-[200px] snap-center">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="<?php echo e(asset('images/testimoni2.jpeg')); ?>" alt="Mahasiswa" class="w-10 h-10 rounded-full shrink-0 object-cover">

                <div class="ml-3">

                  <p class="font-semibold font-poppins text-[15px]">Mahasiswa</p>

                  <p class="font-poppins text-sm text-gray-600">Pengguna Bimbingan Skripsi</p>
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[45vw] lg:w-[400px] xl:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto min-h-[200px] snap-center">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="<?php echo e(asset('images/testimoni3.jpeg')); ?>" alt="Pemilik UMKM" class="w-10 h-10 rounded-full shrink-0 object-cover">

                <div class="ml-3">

                  <p class="font-semibold font-poppins text-[15px]">Pemilik UMKM</p>

                  <p class="font-poppins text-sm text-gray-600">Pengguna Senku Design</p>
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[45vw] lg:w-[400px] xl:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto min-h-[200px] snap-center">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="<?php echo e(asset('images/testimoni4.jpeg')); ?>" alt="Klien Konsultasi" class="w-10 h-10 rounded-full shrink-0 object-cover">

                <div class="ml-3">

                  <p class="font-semibold font-poppins text-[15px]">Klien Konsultasi</p>

                  <p class="font-poppins text-sm text-gray-600">Pengguna Senku Consultation</p>
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[45vw] lg:w-[400px] xl:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto min-h-[200px] snap-center">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="<?php echo e(asset('images/testimoni5.jpeg')); ?>" alt="Peneliti Sosial" class="w-10 h-10 rounded-full shrink-0 object-cover">

                <div class="ml-3">

                  <p class="font-semibold font-poppins text-[15px]">Peneliti Sosial</p>
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[45vw] lg:w-[400px] xl:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto min-h-[200px] snap-center">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="<?php echo e(asset('images/testimoni6.jpeg')); ?>" alt="Koordinator Event" class="w-10 h-10 rounded-full shrink-0 object-cover">

                <div class="ml-3">

                  <p class="font-semibold font-poppins text-[15px]">Koordinator Event</p>
        ...
        <div class="hidden xl:flex justify-center gap-2 mt-6">
          ...
          <button onclick="goToTestimonial(1)" class="testimonial-dot w-3 h-3 rounded-full bg-gray-300 transition-all hover:scale-125"></button>
      ...
      <script>
        ...
        const totalTestimonials = Math.ceil(slider.children.length / cardsPerViewDesktop);
        ...
        function updateDots() {
          ...
          dots.forEach((dot, i) => {
            ...
            if (i === currentTestimonial && isDesktopSlider()) {

              dot.classList.remove('bg-gray-300');

              dot.classList.add('bg-[#B56727]');

            } else {

              dot.classList.remove('bg-[#B56727]');
    ...
    <section class="pattern-overlay w-full h-[146px] md:h-[194px] bg-[#E5E0D8]" aria-hidden="true"></section>
    ...
    <section class="pattern-overlay w-full py-[110px] px-7.5 md:px-30 bg-[#E5E0D8]">
      ...
      <div class="flex items-center flex-col">
        ...
        <div class="flex flex-row justify-around w-full max-w-[240px] px-4 gap-3">

          <a href="https://wa.me/6289699882356" target="_blank" rel="noopener" class="w-[80px] h-[80px] bg-white rounded-[22px] shadow shadow-gray-300 flex justify-center items-center hover:shadow-lg transition">

            <img src="<?php echo e(asset('images/a733546c5df6544c73b41c3847436f517e6e9e2b.png')); ?>" alt="CTA Icon WA" class="w-[48px] h-[48px]">

          </a>

          <a href="https://shopee.co.id/senkusolutions.id" target="_blank" rel="noopener" class="w-[80px] h-[80px] bg-white rounded-[22px] shadow shadow-gray-300 flex justify-center items-center hover:shadow-lg transition">

            <img src="<?php echo e(asset('images/22f5dea3c59bcc9f94f3eae6c26ea3394badb610.png')); ?>" alt="Shopee Senku Solutions" class="w-[46px] h-[58px]">
    ...
    <footer class="w-full bg-[#ECEAE4] text-[#1F1F1F] px-7.5 md:px-30 pt-16 pb-4">

      <div class="max-w-6xl mx-auto grid gap-10 md:grid-cols-5">
        ...
        <div class="md:col-span-2 space-y-5">
          ...
          <div class="flex flex-col gap-3">
            ...
            <div class="space-y-1">
              ...
              <p class="font-mochi text-[28px] text-[#5F6F52] leading-tight">Senku Solutions</p>

              <p class="text-lg text-[#6B6B68] leading-snug">Jakarta</p>

            </div>

          </div>

          <p class="font-poppins text-sm leading-relaxed text-[#4A4A46]">Solusi terpercaya untuk penduduk, kreativitas, dan kebutuhan hukum Anda. Kami hadir sebagai partner yang responsif untuk setiap tantangan akademik maupun profesional.</p>
          <a href="<?php echo e(route('home')); ?>#hero-section" data-learn-more class="inline-flex items-center gap-2 font-poppins text-sm font-semibold text-[#B56727] hover:underline">
            Learn more
        ...
        <div class="space-y-4">
          ...
          <h4 class="font-poppins font-semibold text-lg text-[#5F6F52]">Jelajahi</h4>

          <ul class="space-y-2 text-sm font-poppins">

            <li><a href="<?php echo e(route('cara_order')); ?>" class="hover:text-[#B56727]">Cara Order</a></li>

            <li><a href="<?php echo e(route('testimoni')); ?>" class="hover:text-[#B56727]">Testimoni</a></li>

            <li><a href="<?php echo e(route('faq')); ?>" class="hover:text-[#B56727]">FAQ</a></li>

            <li><a href="<?php echo e(route('kontak')); ?>" class="hover:text-[#B56727]">Kontak</a></li>

            <li><a href="<?php echo e(route('home')); ?>#tentang" class="hover:text-[#B56727]">Tentang Kami</a></li>
        ...
        <div class="space-y-4">
          ...
          <h4 class="font-poppins font-semibold text-lg text-[#5F6F52]">Layanan Kami</h4>

          <ul class="space-y-2 text-sm font-poppins">

            <li>Bantuan Akademik &amp; Skripsi</li>

            <li>Desain Visual &amp; Edit Foto</li>

            <li>Buat Brand &amp; Konten</li>
        ...
        <div class="space-y-5" style="width: calc(100% + 50px);">

          <h4 class="font-poppins font-semibold text-lg text-[#5F6F52]">Hubungi Kami</h4>

          <div class="text-sm font-poppins space-y-2">

            <p>Email: <a href="mailto:info@senkusolutions.com" class="hover:text-[#B56727]">info@senkusolutions.com</a></p>

            <p>WhatsApp: <a href="https://wa.me/6289699882356" target="_blank" rel="noopener" class="hover:text-[#B56727]">089699882356</a></p>

          </div>

          <div>

            <p class="font-poppins font-semibold text-sm text-[#5F6F52] mb-3">Follow Us</p>

            <div class="flex gap-3 flex-wrap">

              <a href="https://www.instagram.com/senkusolutions.id" target="_blank" rel="noopener" class="w-11 h-11 bg-white rounded-2xl shadow flex items-center justify-center">

                <img src="<?php echo e(asset('images/instagram.png')); ?>" alt="Instagram" class="w-6 h-6">

              </a>

              <a href="https://www.tiktok.com/@senku.solutions" target="_blank" rel="noopener" class="w-11 h-11 bg-white rounded-2xl shadow flex items-center justify-center">

                <img src="<?php echo e(asset('images/tiktok.png')); ?>" alt="TikTok" class="w-7 h-7">

              </a>

              <a href="https://x.com/senkusolutions" target="_blank" rel="noopener" class="w-11 h-11 bg-white rounded-2xl shadow flex items-center justify-center">

                <img src="<?php echo e(asset('images/x.png')); ?>" alt="X" class="w-6 h-6">

              </a>

              <a href="https://www.threads.net/@senkusolutions.id" target="_blank" rel="noopener" class="w-11 h-11 bg-white rounded-2xl shadow flex items-center justify-center">

                <img src="<?php echo e(asset('images/threads.png')); ?>" alt="Threads" class="w-7 h-7">
      ...
      <div class="max-w-6xl mx-auto mt-12 border-t border-[#D5D2CB] pt-6 text-center text-xs font-poppins text-[#6B6B68]">

        <?php echo e(date('Y')); ?> Senku Solutions. All rights reserved.
  ...
  <a
    ...
    href="https://wa.me/6289699882356"

    target="_blank"

    rel="noopener"

    class="fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full bg-[#25D366] shadow-lg shadow-black/20 flex items-center justify-center hover:scale-110 transition-transform"

    aria-label="Hubungi Senku via WhatsApp"

  >

    <img src="<?php echo e(asset('images/a733546c5df6544c73b41c3847436f517e6e9e2b.png')); ?>" alt="WhatsApp" class="w-10 h-10">

  </a>

  <script>
    document.addEventListener('DOMContentLoaded', function () {
      const dropdown = document.getElementById('hero-about-dropdown');
      const footerLink = document.querySelector('[data-learn-more]');
      const closeBtn = document.getElementById('close-hero-about');
      const hero = document.getElementById('hero-section');

      if (!dropdown || !footerLink || !closeBtn) {
        return;
      }
      ...
      const openDropdown = () => {
        ...
        const handleOpen = (event) => {
          ...
          dropdown.removeEventListener('transitionend', handleOpen);
        };

        dropdown.addEventListener('transitionend', handleOpen);
      };
      ...
      footerLink.addEventListener('click', function (event) {
        ...
        const shouldOpen = dropdown.dataset.expanded !== 'true';
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      if (!('IntersectionObserver' in window)) {
        ...
        heroElements.forEach(function (element) {
          ...
          element.classList.add('hero-fade-visible');
      ...
      const observer = new IntersectionObserver(function (entries) {
        ...
        entries.forEach(function (entry) {
          ...
          if (entry.isIntersecting) {
            ...
            entry.target.classList.add('hero-fade-visible');

          } else {

            entry.target.classList.remove('hero-fade-visible');
...
</html><?php /**PATH C:\LARAGON\laragon\www\senku-backend\resources\views/pages/index.blade.php ENDPATH**/ ?>