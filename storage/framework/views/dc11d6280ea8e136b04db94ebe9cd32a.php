...
<head>
  ...
  <style>
    ...
    .pattern-overlay::before {
      ...
      background-image: url('<?php echo e(asset('images/background%20pattern.png')); ?>');
      ...
      <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('images/7343c1fc35b5281de35c18d65f3824a08927c1b7.png')); ?>"
        ...
        <div class="relative">
          ...
          >
            ...
            <a href="<?php echo e(route('siswa.login')); ?>" class="block px-4 py-2 hover:bg-gray-100">

              Siswa

            </a>

            <a href="<?php echo e(route('mahasiswa.login')); ?>" class="block px-4 py-2 hover:bg-gray-100">

              Mahasiswa

            </a>

            <a href="<?php echo e(route('umum.login')); ?>" class="block px-4 py-2 hover:bg-gray-100">
    ...
    <section id="hero-section" class="pattern-overlay w-full bg-[#5F6F52] px-7.5 md:px-30 pt-20 flex flex-col gap-6">
      ...
      <div class="flex flex-col lg:flex-row gap-5">
        ...
        <div class="flex-1 hidden md:block md:max-w-sm lg:max-w-md xl:max-w-lg ml-auto pl-4 md:pl-8">
          ...
          <img src="<?php echo e(asset('images/hero.png')); ?>" alt="Hero Image" class="hero-fade-right w-full h-auto" data-hero-animate>
        ...
        <div class="rounded-[20px] md:max-w-72 text-[14px] flex-1 p-4 bg-white -mt-10 shadow-xl shadow-gray-400 flex flex-col h-full min-h-[360px] hero-fade-up" data-hero-animate>
          ...
          <div class="flex mb-4 min-h-[120px]">
            ...
            <div class="flex-1">
              ...
              <img src="<?php echo e(asset('images/e7112bf1923a361b34ce13055c57d032c50a17ca.png')); ?>" alt="icon" class="w-16 h-16">
        ...
        <div class="rounded-[20px] md:max-w-72 text-[14px] flex-1 p-4 bg-white -mt-10 shadow-xl shadow-gray-400 flex flex-col h-full min-h-[360px] hero-fade-up" data-hero-animate>
          ...
          <div class="flex mb-4 min-h-[120px]">
            ...
            <div class="flex-1">
              ...
              <img src="<?php echo e(asset('images/78b570f382834f7c2682ac6349195a12978b9273.png')); ?>" alt="icon" class="w-16 h-16">
        ...
        <div class="rounded-[20px] md:max-w-72 text-[14px] flex-1 p-4 bg-white -mt-10 shadow-xl shadow-gray-400 flex flex-col h-full min-h-[360px] hero-fade-up" data-hero-animate>
          ...
          <div class="flex mb-4 min-h-[120px]">
            ...
            <div class="flex-1">
              ...
              <img src="<?php echo e(asset('images/ac1a0c3d62e9c6c03c8dd582e9d5f93097ccb8ec.png')); ?>" alt="icon" class="w-16 h-16">
