...
<body class="bg-[#5F6F52]">
  ...
  <main>
    <section class="min-h-screen bg-[#E9E5DC] relative flex flex-col items-center py-12">
      ...
      <div class="absolute inset-0 opacity-20 pointer-events-none bg-cover" style="background-image: url('<?php echo e(asset('images/background%20pattern.png')); ?>')"></div>
      ...
      <div class="relative z-10 bg-white w-[90%] md:w-full max-w-3xl rounded-2xl p-3 md:p-10 shadow-sm">
          ...
          <?php if(isset($cartItems) && $cartItems->count() > 0): ?>
              ...
              <div class="flex items-center gap-4 pb-6 mb-6 border-b border-gray-200">
                  <div class="w-16 h-16 rounded-lg bg-gray-300 overflow-hidden flex-shrink-0">
                      ...
                      ?>
                      <?php if($cartItemImage): ?>
                          <img src="<?php echo e($cartItemImage); ?>" alt="<?php echo e($item->layanan->nama_layanan); ?>" class="w-full h-full object-cover">
                  ...
                  <div class="flex-1">
                      <p class="font-semibold"><?php echo e($item->layanan->nama_layanan); ?></p>
                      <p class="text-sm text-gray-500"><?php echo e(Str::limit($item->layanan->deskripsi_layanan, 100)); ?></p>
                      <p class="text-sm mt-1 text-gray-600">Qty: <?php echo e($item->quantity); ?> x Rp <?php echo e(number_format($item->harga_satuan, 0, ',', '.')); ?></p>
                      <p class="text-sm mt-1 font-semibold text-orange-500">Subtotal: Rp <?php echo e(number_format($item->subtotal, 0, ',', '.')); ?></p>
                  </div>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          <?php elseif(isset($layanan) && $layanan): ?>
          ...
          <div class="flex items-center gap-4 pb-6">
              <div class="w-16 h-16 rounded-lg bg-gray-300 overflow-hidden">
                  ...
                  ?>
                  <?php if($layananImage): ?>
                      <img src="<?php echo e($layananImage); ?>" alt="<?php echo e($layanan->nama_layanan); ?>" class="w-full h-full object-cover">
              ...
              <div class="flex-1">
                  <p class="font-semibold"><?php echo e($layanan->nama_layanan); ?></p>
                  <p class="text-sm text-gray-500"><?php echo e(Str::limit($layanan->deskripsi_layanan, 100)); ?></p>
                  <p class="text-sm mt-1 font-semibold text-orange-500">Rp <?php echo e(number_format($layanan->harga_layanan, 0, ',', '.')); ?></p>
              </div>
          </div>
          ...
          <?php if($additionalLayanan->count() > 0): ?>
          <div class="mt-8">
              <h3 class="text-center font-semibold mb-6">Additional Produk</h3>

              <?php $__currentLoopData = $additionalLayanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $additional): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              
              <div class="border rounded-xl p-4 flex justify-between items-center mb-4">
                  <div class="flex-1">
                      <p class="font-medium"><?php echo e($additional->nama_layanan); ?></p>
                      <p class="text-xs text-gray-500 mt-1"><?php echo e(Str::limit($additional->deskripsi_layanan, 80)); ?></p>
                      <p class="text-sm text-orange-500 mt-2">Rp <?php echo e(number_format($additional->harga_layanan, 0, ',', '.')); ?></p>
                  </div>

                  <div class="flex items-center gap-3">
                      <button class="w-8 h-8 rounded bg-gray-200 hover:bg-gray-300 transition" onclick="decrementQty(<?php echo e($additional->id); ?>)">−</button>
                      <span id="qty-<?php echo e($additional->id); ?>">0</span>
                      <button class="w-8 h-8 rounded bg-gray-200 hover:bg-gray-300 transition" onclick="incrementQty(<?php echo e($additional->id); ?>, <?php echo e($additional->harga_layanan); ?>)">+</button>
                  </div>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          ...
          <div class="mt-8">
              ...
              <div class="bg-gray-50 rounded-lg p-4">
                  <p class="text-sm text-gray-700 whitespace-pre-line"><?php echo e($layanan->deskripsi_layanan); ?></p>
              </div>
          </div>
          <?php endif; ?>
      ...
      <form id="checkout-form" action="<?php echo e(route('order.co-verification')); ?>" method="GET" class="relative z-10 mt-4">
          <input type="hidden" name="items" id="checkout-items">
          <input type="hidden" name="total" id="checkout-total">
          <input type="hidden" name="from_cart" value="<?php echo e(isset($cartItems) && $cartItems->count() > 0 ? '1' : '0'); ?>">
      ...
      <script>
        ...
        snkLink?.addEventListener('click', function () {
            ...
            window.location.href = '<?php echo e(route('order.co-snk')); ?>?return=' + encodedReturn;
        });
        ...
        checkoutForm.addEventListener('submit', function(e) {
            ...
            <?php if(isset($cartItems) && $cartItems->count() > 0): ?>
                ...
                <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    items.push({
                        id: <?php echo e($item->layanan->id); ?>,
                        name: "<?php echo e(addslashes($item->layanan->nama_layanan)); ?>",
                        price: <?php echo e($item->harga_satuan); ?>,
                        qty: <?php echo e($item->quantity); ?>,
                        subtotal: <?php echo e($item->subtotal); ?>,
                        image: "<?php echo e(addslashes($item->layanan->thumbnail_url ?? $placeholderImage)); ?>"
                    });
                    total += <?php echo e($item->subtotal); ?>;
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                
                // Add additional items if any selected
                <?php if($additionalLayanan->count() > 0): ?>
                    <?php $__currentLoopData = $additionalLayanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $additional): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        let addQty<?php echo e($additional->id); ?> = parseInt(document.getElementById('qty-<?php echo e($additional->id); ?>')?.textContent || 0);
                        if (addQty<?php echo e($additional->id); ?> > 0) {
                            items.push({
                                id: <?php echo e($additional->id); ?>,
                                name: "<?php echo e(addslashes($additional->nama_layanan)); ?>",
                                price: <?php echo e($additional->harga_layanan); ?>,
                                qty: addQty<?php echo e($additional->id); ?>,
                                subtotal: <?php echo e($additional->harga_layanan); ?> * addQty<?php echo e($additional->id); ?>,
                                image: "<?php echo e(addslashes($additional->thumbnail_url ?? $placeholderImage)); ?>"
                            });
                            total += <?php echo e($additional->harga_layanan); ?> * addQty<?php echo e($additional->id); ?>;
                        }
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            <?php elseif(isset($layanan) && $layanan): ?>
                ...
                items.push({
                    id: <?php echo e($layanan->id); ?>,
                    name: "<?php echo e(addslashes($layanan->nama_layanan)); ?>",
                    price: <?php echo e($layanan->harga_layanan); ?>,
                    qty: 1,
                    subtotal: <?php echo e($layanan->harga_layanan); ?>,
                    image: "<?php echo e(addslashes($layanan->thumbnail_url ?? $placeholderImage)); ?>"
                });
                total = <?php echo e($layanan->harga_layanan); ?>;
      ...
      <?php if(isset($layanan) && $layanan): ?>
      <script>
        let basePrice = <?php echo e($layanan->harga_layanan); ?>;
        let additionalItems = {};
        
        // Store additional product metadata
        let additionalMeta = {
            <?php $__currentLoopData = $additionalLayanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $additional): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($additional->id); ?>: {
                name: "<?php echo e(addslashes($additional->nama_layanan)); ?>",
                image: "<?php echo e(addslashes($additional->thumbnail_url ?? $placeholderImage)); ?>"
...
</html><?php /**PATH C:\LARAGON\laragon\www\senku-backend\resources\views/order/co-detail.blade.php ENDPATH**/ ?>