...
<body class="bg-[#5F6F52]">
  <nav class="w-full px-7.5 md:px-30 py-5 h-fit bg-[#E5E0D8] sticky top-0 z-50 border-b border-gray-700">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-5 items-center ml-auto">
          ...
          <a href="<?php echo e(route('user.profile')); ?>#status-pesanan" class="font-poppins font-light text-[1.1em]">
  ...
  <main class="relative">
    <div class="absolute inset-0 opacity-20 pointer-events-none z-0 bg-size-[100%]" style="background-image: url('<?php echo e(asset('images/background%20pattern.png')); ?>')"></div>
        ...
        <div class="flex flex-col lg:flex-row gap-6">
          ...
          <div class="bg-white p-4 rounded-xl flex flex-col gap-4 lg:w-[25%]">
            <?php if($user->foto_profil): ?>
              <img src="<?php echo e(asset('storage/' . $user->foto_profil)); ?>" alt="foto profile"
                  class="h-[200px] md:h-[250px] w-full object-cover rounded-lg bg-gray-200">
            <?php else: ?>
              <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name)); ?>&background=5F6F52&color=fff" alt="foto profile"
                  class="h-[200px] md:h-[250px] w-full object-cover rounded-lg bg-gray-200">
            <?php endif; ?>

            <form action="<?php echo e(route('profile.update-photo')); ?>" method="POST" enctype="multipart/form-data" class="flex flex-col gap-3">
              <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="flex flex-col gap-4 lg:flex-1 min-w-0">
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 space-y-3">
              ...
              <div class="flex items-start border-b border-white/20 pb-3">
                ...
                <span class="font-poppins text-white font-semibold flex-1"><?php echo e($user->name); ?></span>
              </div>

              <!-- NPM/NISN -->
              <?php if($user->user_type === 'mahasiswa' && $user->nim): ?>
                <div class="flex items-start border-b border-white/20 pb-3">
                  <span class="font-poppins text-white/80 w-32 md:w-40 flex-shrink-0">NPM</span>
                  <span class="font-poppins text-white font-semibold flex-1"><?php echo e($user->nim); ?></span>
                </div>
              <?php elseif($user->user_type === 'siswa' && $user->nisn): ?>
                <div class="flex items-start border-b border-white/20 pb-3">
                  <span class="font-poppins text-white/80 w-32 md:w-40 flex-shrink-0">NISN</span>
                  <span class="font-poppins text-white font-semibold flex-1"><?php echo e($user->nisn); ?></span>
                </div>
              <?php endif; ?>
              ...
              <div class="flex items-start border-b border-white/20 pb-3">
                ...
                <span class="font-poppins text-white font-semibold flex-1">
                  <?php echo e($user->tanggal_lahir ? \Carbon\Carbon::parse($user->tanggal_lahir)->format('d/m/Y') : 'Belum diisi'); ?>
              ...
              <?php if($user->jenis_kelamin): ?>
                <div class="flex items-start border-b border-white/20 pb-3">
                  ...
                  <span class="font-poppins text-white font-semibold flex-1">
                    <?php echo e($user->jenis_kelamin === 'L' ? 'Laki-laki' : 'Perempuan'); ?>
              ...
              <?php if($user->alamat): ?>
                <div class="flex items-start pb-3">
                  ...
                  <span class="font-poppins text-white font-semibold flex-1"><?php echo e($user->alamat); ?></span>
                </div>
              <?php endif; ?>
            </div>
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 space-y-3">
              ...
              <div class="flex items-start border-b border-white/20 pb-3">
                ...
                <span class="font-poppins text-white font-semibold flex-1"><?php echo e($user->email); ?></span>
              </div>

              <!-- Nomor HP -->
              <div class="flex items-start">
                <span class="font-poppins text-white/80 w-32 md:w-40 flex-shrink-0">Nomor HP</span>
                <span class="font-poppins text-white font-semibold flex-1"><?php echo e($user->no_hp ?? 'Belum diisi'); ?></span>
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-col gap-4 lg:w-[30%]">
            ...
            <div class="bg-white p-4 rounded-xl flex flex-col gap-2">
              ...
              <form action="<?php echo e(route('profile.update-name')); ?>" method="POST" class="flex flex-col gap-2">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white p-4 rounded-xl flex flex-col gap-2">
              ...
              <form action="<?php echo e(route('profile.update-birthdate')); ?>" method="POST" class="flex flex-col gap-2">
                <?php echo csrf_field(); ?>
                <div class="flex gap-2 justify-center">
                  <input type="number" name="tanggal" min="1" max="31" 
                         value="<?php echo e($user->tanggal_lahir ? \Carbon\Carbon::parse($user->tanggal_lahir)->format('d') : ''); ?>"
                         class="flex-1 bg-[#D9D9D9] p-2 rounded-lg font-poppins max-w-20" 
                         placeholder="Tanggal" required>
                  <input type="number" name="bulan" min="1" max="12" 
                         value="<?php echo e($user->tanggal_lahir ? \Carbon\Carbon::parse($user->tanggal_lahir)->format('m') : ''); ?>"
                  ...
                  <input type="number" name="tahun" min="1900" max="<?php echo e(date('Y')); ?>" 
                         value="<?php echo e($user->tanggal_lahir ? \Carbon\Carbon::parse($user->tanggal_lahir)->format('Y') : ''); ?>"
                         class="flex-1 bg-[#D9D9D9] p-2 rounded-lg font-poppins max-w-20" 
      ...
      <div class="w-full max-w-6xl mt-8">
        <?php if($pesanans->isEmpty()): ?>
          <div class="bg-white rounded-xl p-8 text-center">
            ...
            <a href="<?php echo e(route('user.dashboard')); ?>" class="inline-block bg-[#5F6F52] text-white px-6 py-2 rounded-lg hover:bg-[#4a5640] transition">
              Lihat Layanan
            </a>
          </div>
        <?php else: ?>
              ...
              <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div class="flex-1">
                    <div class="flex items-center gap-3 mb-2">
                      <h3 class="text-lg font-bold text-[#5F6F52]"><?php echo e($pesanan->kode_pesanan); ?></h3>
                      <span class="<?php echo e($pesanan->status_badge); ?> text-white text-xs px-3 py-1 rounded-full">
                        <?php echo e($pesanan->status_label); ?>

                      </span>
                    </div>
                    <p class="text-gray-700 font-semibold"><?php echo e($pesanan->layanan->nama ?? 'Layanan'); ?></p>
                    <p class="text-sm text-gray-500 mt-1"><?php echo e($pesanan->nama_pemesan); ?></p>
                    <div class="flex gap-4 mt-2 text-sm text-gray-600">
                      <span>📅 Deadline: <?php echo e($pesanan->deadline->format('d M Y')); ?></span>
                      <span>💰 Rp <?php echo e(number_format($pesanan->total_harga, 0, ',', '.')); ?></span>
                    </div>
                  </div>
                  <div class="flex gap-2">
                    <a href="<?php echo e(route('user.pesanan.detail', $pesanan->id)); ?>" 
                ...
                <div class="mt-4 pt-4 border-t border-gray-200">
                  <div class="flex items-center justify-between text-xs">
                    <div class="flex flex-col items-center <?php echo e(in_array($pesanan->status, ['pending', 'processing', 'completed', 'selesai']) ? 'text-[#B56727]' : 'text-gray-400'); ?>">
                      <div class="w-8 h-8 rounded-full <?php echo e(in_array($pesanan->status, ['pending', 'processing', 'completed', 'selesai']) ? 'bg-[#B56727]' : 'bg-gray-300'); ?> flex items-center justify-center text-white mb-1">1</div>
                      <span class="text-center">Menunggu<br>Pembayaran</span>
                    </div>
                    <div class="flex-1 h-1 <?php echo e(in_array($pesanan->status, ['processing', 'completed', 'selesai']) ? 'bg-[#B56727]' : 'bg-gray-300'); ?> mx-2"></div>
                    <div class="flex flex-col items-center <?php echo e(in_array($pesanan->status, ['processing', 'completed', 'selesai']) ? 'text-[#B56727]' : 'text-gray-400'); ?>">
                      <div class="w-8 h-8 rounded-full <?php echo e(in_array($pesanan->status, ['processing', 'completed', 'selesai']) ? 'bg-[#B56727]' : 'bg-gray-300'); ?> flex items-center justify-center text-white mb-1">2</div>
                      <span class="text-center">Diproses</span>
                    </div>
                    <div class="flex-1 h-1 <?php echo e(in_array($pesanan->status, ['completed', 'selesai']) ? 'bg-[#B56727]' : 'bg-gray-300'); ?> mx-2"></div>
                    <div class="flex flex-col items-center <?php echo e(in_array($pesanan->status, ['completed', 'selesai']) ? 'text-[#B56727]' : 'text-gray-400'); ?>">
                      <div class="w-8 h-8 rounded-full <?php echo e(in_array($pesanan->status, ['completed', 'selesai']) ? 'bg-[#B56727]' : 'bg-gray-300'); ?> flex items-center justify-center text-white mb-1">3</div>
...
</html><?php /**PATH C:\LARAGON\laragon\www\senku-backend\resources\views/user/profile.blade.php ENDPATH**/ ?>