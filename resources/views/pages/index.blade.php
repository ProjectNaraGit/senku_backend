...
<body class="bg-[#5F6F52] overflow-x-hidden">
          ...
          <div id="testimonialSlider" class="flex flex-col md:flex-row gap-4 md:gap-5 transition-none md:transition-transform md:duration-700 md:ease-in-out">
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto md:h-[200px]">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="{{ asset('images/testimoni1.jpeg') }}" alt="Mahasiswa Hukum" class="w-10 h-10 rounded-full shrink-0 object-cover">
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto md:h-[200px]">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="{{ asset('images/testimoni2.jpeg') }}" alt="Mahasiswa" class="w-10 h-10 rounded-full shrink-0 object-cover">
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto md:h-[200px]">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="{{ asset('images/testimoni3.jpeg') }}" alt="Pemilik UMKM" class="w-10 h-10 rounded-full shrink-0 object-cover">
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto md:h-[200px]">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="{{ asset('images/testimoni4.jpeg') }}" alt="Klien Konsultasi" class="w-10 h-10 rounded-full shrink-0 object-cover">
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto md:h-[200px]">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="{{ asset('images/testimoni5.jpeg') }}" alt="Peneliti Sosial" class="w-10 h-10 rounded-full shrink-0 object-cover">
            ...
            <div class="rounded-xl p-5 bg-white border border-[#E6E6E6] shadow w-full md:w-[calc(33.333%-13.33px)] shrink-0 flex flex-col h-auto md:h-[200px]">
              ...
              <div class="flex items-center mt-auto">
                ...
                <img src="{{ asset('images/testimoni6.jpeg') }}" alt="Koordinator Event" class="w-10 h-10 rounded-full shrink-0 object-cover">
      ...
      <div class="flex items-center flex-col">
        ...
        <div class="flex flex-row justify-around w-full max-w-[240px] px-4 gap-3">
          ...
          <a href="https://wa.me/6289699882356" target="_blank" rel="noopener" class="w-[80px] h-[80px] bg-white rounded-[22px] shadow shadow-gray-300 flex justify-center items-center hover:shadow-lg transition">
            ...
            <img src="{{ asset('images/a733546c5df6544c73b41c3847436f517e6e9e2b.png') }}" alt="CTA Icon WA" class="w-[48px] h-[48px]">
          ...
          <a href="https://shopee.co.id/senkusolutions.id" target="_blank" rel="noopener" class="w-[80px] h-[80px] bg-white rounded-[22px] shadow shadow-gray-300 flex justify-center items-center hover:shadow-lg transition">
            ...
            <img src="{{ asset('images/22f5dea3c59bcc9f94f3eae6c26ea3394badb610.png') }}" alt="Shopee Senku Solutions" class="w-[46px] h-[58px]">
    ...
    <footer class="w-full bg-[#ECEAE4] text-[#1F1F1F] px-7.5 md:px-30 pt-16 pb-4">
      ...
      <div class="max-w-6xl mx-auto grid gap-10 md:grid-cols-5">
        ...
        <div class="md:col-span-2 space-y-5">
          ...
          <a href="{{ route('home') }}#hero-section" data-learn-more class="inline-flex items-center gap-2 font-poppins text-sm font-semibold text-[#B56727] hover:underline">
            Learn more
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2 text-sm font-poppins">
            ...
            <li><a href="{{ route('cara_order') }}" class="hover:text-[#B56727]">Cara Order</a></li>

            <li><a href="{{ route('testimoni') }}" class="hover:text-[#B56727]">Testimoni</a></li>

            <li><a href="{{ route('faq') }}" class="hover:text-[#B56727]">FAQ</a></li>

            <li><a href="{{ route('kontak') }}" class="hover:text-[#B56727]">Kontak</a></li>

            <li><a href="{{ route('home') }}#tentang" class="hover:text-[#B56727]">Tentang Kami</a></li>
          ...
          <div>
            ...
            <div class="flex gap-3 flex-wrap">
              ...
              <a href="https://x.com/senkusolutions" target="_blank" rel="noopener" class="w-11 h-11 bg-white rounded-2xl shadow flex items-center justify-center">
                ...
                <img src="{{ asset('images/x.png') }}" alt="X" class="w-6 h-6">
              ...
              <a href="https://www.threads.net/@senkusolutions.id" target="_blank" rel="noopener" class="w-11 h-11 bg-white rounded-2xl shadow flex items-center justify-center">
                ...
                <img src="{{ asset('images/threads.png') }}" alt="Threads" class="w-7 h-7">
      ...
      <div class="max-w-6xl mx-auto mt-12 border-t border-[#D5D2CB] pt-6 text-center text-xs font-poppins text-[#6B6B68]">
        ...
        {{ date('Y') }} Senku Solutions. All rights reserved.
  ...
  >
    ...
    <img src="{{ asset('images/a733546c5df6544c73b41c3847436f517e6e9e2b.png') }}" alt="WhatsApp" class="w-10 h-10">
