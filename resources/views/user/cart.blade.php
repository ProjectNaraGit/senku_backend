        ...
        <div class="w-full bg-white p-6 md:p-10 rounded-2xl">
            ...
            @foreach($cartItems as $item)
              <div class="flex flex-col md:flex-row items-center gap-4 p-4 border-b border-gray-200 last:border-0">
                <div class="w-20 h-20 rounded-lg bg-gray-200 overflow-hidden flex-shrink-0 flex items-center justify-center">
                  ...
                  @if($thumbnail)
                    <img src="{{ $thumbnail }}" alt="{{ $item->layanan->nama_layanan }}" class="w-full h-full object-cover">
                  @else
                ...
                <div class="flex-1">
                  ...
                  <p class="text-sm text-gray-600">{{ Str::limit($item->layanan->deskripsi_layanan, 80) }}</p>
                  <p class="text-sm font-semibold text-[#5F6F52] mt-1">Rp {{ number_format($item->harga_satuan, 0, ',', '.') }}</p>
                </div>
          ...
          <div class="mt-6 pt-6 border-t border-gray-300">
            <div class="flex justify-between items-center mb-4">
              ...
              <span class="text-2xl font-bold text-[#5F6F52]">Rp {{ number_format($total, 0, ',', '.') }}</span>
            </div>
            <div class="flex gap-4">
              <a href="{{ route('user.dashboard') }}" class="flex-1 text-center py-3 px-6 border-2 border-[#5F6F52] text-[#5F6F52] rounded-lg font-semibold hover:bg-gray-50 transition">
                Lanjut Belanja
              </a>
              <a href="{{ route('cart.checkout') }}" class="flex-1 py-3 px-6 bg-[#5F6F52] text-white rounded-lg font-semibold hover:bg-[#4a5841] transition text-center">
                Checkout
              </a>
            </div>
          </div>
      ...
      @else
        <div class="flex flex-col md:flex-row w-full bg-white p-10 gap-7 rounded-2xl">
          ...
          <div class="flex flex-col w-fuil">
            ...
            <a href="{{ route('user.dashboard') }}" class="w-fit mt-3 font-poppins font-bold text-white bg-[#5F6F52] py-1 px-20 rounded-xl text-center">Mulai Belanja</a>
          </div>
        </div>
      @endif
    </section>
